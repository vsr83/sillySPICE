...
struct {
    ...
    STAT_CAPACITANCE,    CLASS_PASSIVE,   "C",          true,  false, 3, 5,    "Capacitance",
    ...
    STAT_CURRENTSOURCE,  CLASS_SOURCE,    "I",          true,  false, 3, 5,    "Current Source",
    STAT_VCVS,           CLASS_SOURCE,    "E",          true,  false, 5, 5,    "Voltage-Controlled Voltage Source",
    STAT_CCCS,           CLASS_SOURCE,    "F",          true,  false, 4, 4,    "Current-Controlled Current Source",
    STAT_VCCS,           CLASS_SOURCE,    "G",          true,  false, 5, 5,    "Voltage-Controlled Current Source",
    STAT_CCVS,           CLASS_SOURCE,    "H",          true,  false, 4, 1024, "Current-Controlled Voltage Source",
    ...
    STAT_ANALYSISTRAN,   CLASS_ANALYSIS,  ".TRAN",      false, false, 2, 4,    "Transient Analysis",
